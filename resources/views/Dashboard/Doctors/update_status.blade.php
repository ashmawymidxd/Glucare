<!-- Modal -->
<div class="modal fade update-status-modal" id="update_status{{ $doctor->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('Doctors_update_status') }}" method="post" autocomplete="off" class="updateStatusForm">
                {{ csrf_field() }}
