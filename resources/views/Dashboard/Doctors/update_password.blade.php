<!-- Modal -->
<div class="modal fade update-password-modal" id="update_password{{ $doctor->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('Doctors_update_password') }}" method="post" autocomplete="off" class="updatePasswordForm">
                {{ csrf_field() }}
