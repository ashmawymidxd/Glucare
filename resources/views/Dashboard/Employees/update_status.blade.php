<!-- Modal -->
<div class="modal fade update-status-modal" id="update_status{{ $employee->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('Employees_update_status') }}" method="post" autocomplete="off" class="updateStatusForm">
                {{ csrf_field() }}
            ...
            $('.updateStatusForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    complete: function() {
                        ...
                        $('.submitButton_USD').prop('disabled', false).html('Submit');
