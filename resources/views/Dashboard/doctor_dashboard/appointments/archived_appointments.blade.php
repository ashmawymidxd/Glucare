...
@section('page-url')
    <h6 class="pt-1">Dashboard / appointment / <span class="active">archived appointments</span></h6>
@endsection
                    ...
                    <table id="DataTable" class="table table-striped rounded-0">
                        ...
                        <tbody>
                            @foreach ($appointments as $appointment)
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li><a class="dropdown-item" href="/" data-mdb-toggle="modal"
                                                        data-mdb-target="#unArchive{{ $appointment->id }}"><i
                                                            style="color:
                                                        #0ba360"
                                                            class="fas fa-archive"></i>&nbsp;&nbsp;
                                                        Un Archive
                                ...
                                @include('Dashboard.doctor_dashboard.appointments.unArchive')
