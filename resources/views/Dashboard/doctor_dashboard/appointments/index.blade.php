...
@section('page-url')
    <h6 class="pt-1">Dashboard / appointment / <span class="active"> appointments </span></h6>
@endsection
                        ...
                        <tbody>
                            @foreach ($appointments as $appointment)
                                <tr>
                                    ...
                                    <td><a href="{{route('patient_details',$appointment->patient_id)}}">{{ $appointment->patient->name }}</a></td>
