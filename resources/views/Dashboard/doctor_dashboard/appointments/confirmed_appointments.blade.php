                    ...
                    <table id="DataTable" class="table table-striped rounded-0">
                        ...
                        <tbody>
                            @foreach ($appointments as $appointment)
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="/doctor_patient_message/{{ $appointment->patient_id }}"><i
                                                            style="color:
                                                        #000000"
                                                ...
                                                <li><a class="dropdown-item" href="/video_call"><i
                                                            style="color:
                                                        #000000"
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="#" data-mdb-toggle="modal"
                                                        data-mdb-target="#add_diagnosis{{ $appointment->id }}"><i
                                                            class="text-dark fa fa-stethoscope"></i>&nbsp;&nbsp;اضافة
                                                        Diagnosis </a>
                                                </li>
                                ...
                                @include('Dashboard.doctor_dashboard.appointments.add_diagnosis')
                            @endforeach
                        </tbody>
                        <tfoot>
                            <tr>
