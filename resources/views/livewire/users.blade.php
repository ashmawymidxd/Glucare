        ...
        @foreach ($users as $key => $user)
            ...
            <div class="w-full bg-white border border-gray-200 rounded-lg p-5 shadow">
                ...
                <div class="flex flex-col items-center pb-10">
                    @if ($user->image)
                        <img src="{{ URL('Dashboard/img/profile/users/' . $user->image->filename) }}" alt="image"
                            class="w-24 h-24 mb-2 5 rounded-full shadow-lg">
                    @else
                        <img src="{{ URL('Dashboard/img/profile/users/default.png') }}" alt="image"
                            class="w-24 h-24 mb-2 5 rounded-full shadow-lg">
                    @endif
                    ...
                    <div class="flex mt-4 space-x-3 md:mt-6">
                        ...
                        <x-primary-button wire:click="message({{ $user->id }})" style="background-color: rgb(59 113 202);color:white">
                            Message
                        </x-primary-button>
