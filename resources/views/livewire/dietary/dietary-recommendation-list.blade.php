                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="input-group py-3">
                                ...
                                <input type="text" name="" id="search_Breackfast" class="form-control"
                            ...
                            <div class="input-group py-3">
                                ...
                                <input type="text" name="" id="search_Dinner" class="form-control"
                            ...
                            <div class="input-group py-3">
                                ...
                                <input type="text" name="" id="search_Lunch" class="form-control"
                            ...
                            <div class="input-group py-3">
                                ...
                                <input type="text" name="" id="search_Protiens" class="form-control"
                            ...
                            <div class="input-group py-3">
                                ...
                                <input type="text" name="" id="search_Fat" class="form-control"
                                    placeholder="By Fats">
                            </div>
                            <div class="input-group py-3">
                                <button class="btn btn-secondary">
                                ...
                                <input type="text" name="" id="search_Carp" class="form-control"
...
<script>
    $("#search_Breackfast").keyup(function() {
    ...
    $("#search_Protiens").keyup(function() {
        let value = $(this).val().toLowerCase();
        $(".all_items .one_item").filter(function() {
            $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
        });
