    ...
    <div class="mx-4 my-3" id="print">
        <div class="container-fluid card p-0" style="margin-top: -70px">
            <div class="card-body" >
                ...
                <div class="row mg-t-20 my-3" id="row">
                    ...
                    <table class="table table-invoice border text-md-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="tx-right" colspan="2">{{ Request::get('discount_value') }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="tx-right tx-uppercase tx-bold tx-inverse">الاجمالي شامل الضريبه
                                </td>
                                <td class="tx-right" colspan="2">
